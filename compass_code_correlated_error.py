...
class CorrelatedDecoder:
    ...
    def get_num_log_errors_DEM(self, circuit, num_shots, enable_corr, enable_pymatch_corr, meas_type, enable_belief_matching, CD_type="SC", max_bp_iters=20):
        """
    ...
    def get_log_error_circuit_level(self, p_list, meas_type, num_shots, noise_model="code_cap", cd_type="SC", corr_decoding= False, pymatch_corr = False, fully_biased=True, enable_belief_matching=False, max_bp_iters=20):
        """
        ...
        for p in p_list:
            ...
            log_errors_array = self.get_num_log_errors_DEM(circuit, num_shots, corr_decoding, pymatch_corr, meas_type, enable_belief_matching, CD_type=cd_type, max_bp_iters=max_bp_iters)
...
def get_data_DCC(
    ...
    if circuit_data and not (corr_decoding or pymatch_corr): # change this to get different data for circuit level plot
        ...
        if p_th_init_d is not None:
            ...
            p_list = np.linspace(max(p_th_init - p_range, 0.0), min(p_th_init + p_range, 1.0), 20)
...
if __name__ == "__main__":
    ...
    p_th_init_bias_preserving_CL = {
        ######### eta = 0.5 ################
        (2,0.5, "X_MEM", "SC", "circuit_level"):0.00775, (2,0.5, "Z_MEM", "SC", "circuit_level"):0.00856, (2,0.5, "TOTAL_MEM", "SC", "circuit_level"):0.00797, 
        (3,0.5, "X_MEM", "SC", "circuit_level"):0.00900, (3,0.5, "Z_MEM", "SC", "circuit_level"):0.00641, (3,0.5, "TOTAL_MEM", "SC", "circuit_level"):0.00684, 
        (4,0.5, "X_MEM", "SC", "circuit_level"):0.01010, (4,0.5, "Z_MEM", "SC", "circuit_level"):0.00522, (4,0.5, "TOTAL_MEM", "SC", "circuit_level"):0.00539, 
        (5,0.5, "X_MEM", "SC", "circuit_level"):0.01062, (5,0.5, "Z_MEM", "SC", "circuit_level"):0.00445, (5,0.5, "TOTAL_MEM", "SC", "circuit_level"):0.00448, 
        (6,0.5, "X_MEM", "SC", "circuit_level"):0.01119, (6,0.5, "Z_MEM", "SC", "circuit_level"):0.00387, (6,0.5, "TOTAL_MEM", "SC", "circuit_level"):0.00393,

        ######### eta = 10 ################
        (2,10, "X_MEM", "SC", "circuit_level"):0.00748, (2,10, "Z_MEM", "SC", "circuit_level"):0.00289, (2,10, "TOTAL_MEM", "SC", "circuit_level"):0.00743,
        (3,10, "X_MEM", "SC", "circuit_level"):0.00981, (3,10, "Z_MEM", "SC", "circuit_level"):0.00213, (3,10, "TOTAL_MEM", "SC", "circuit_level"):0.00984,
        (4,10, "X_MEM", "SC", "circuit_level"):0.01128, (4,10, "Z_MEM", "SC", "circuit_level"):0.01721, (4,10, "TOTAL_MEM", "SC", "circuit_level"):0.01127,
        (5,10, "X_MEM", "SC", "circuit_level"):0.01235, (5,10, "Z_MEM", "SC", "circuit_level"):0.01468, (5,10, "TOTAL_MEM", "SC", "circuit_level"):0.01239,
        (6,10, "X_MEM", "SC", "circuit_level"):0.01326, (6,10, "Z_MEM", "SC", "circuit_level"):0.01248, (6,10, "TOTAL_MEM", "SC", "circuit_level"):0.01322,

        ######### eta = 50 ###############
        (2,50, "X_MEM", "SC", "circuit_level"):0.00742, (2,50, "Z_MEM", "SC", "circuit_level"):0.00736, (2,50, "TOTAL_MEM", "SC", "circuit_level"):0.00749,
        (3,50, "X_MEM", "SC", "circuit_level"):0.00999, (3,50, "Z_MEM", "SC", "circuit_level"):0.00466, (3,50, "TOTAL_MEM", "SC", "circuit_level"):0.00999,
        (4,50, "X_MEM", "SC", "circuit_level"):0.01170, (4,50, "Z_MEM", "SC", "circuit_level"):0.00354, (4,50, "TOTAL_MEM", "SC", "circuit_level"):0.01171,
        (5,50, "X_MEM", "SC", "circuit_level"):0.01294, (5,50, "Z_MEM", "SC", "circuit_level"):0.02651, (5,50, "TOTAL_MEM", "SC", "circuit_level"):0.01292,
        (6,50, "X_MEM", "SC", "circuit_level"):0.01409, (6,50, "Z_MEM", "SC", "circuit_level"):0.00466, (6,50, "TOTAL_MEM", "SC", "circuit_level"):0.01411,

        ######### eta = 100 ###############
        (2,100, "X_MEM", "SC", "circuit_level"):0.00742, (2,100, "Z_MEM", "SC", "circuit_level"):0.00736, (2,100, "TOTAL_MEM", "SC", "circuit_level"):0.00756,
        (3,100, "X_MEM", "SC", "circuit_level"):0.01005, (3,100, "Z_MEM", "SC", "circuit_level"):0.00466, (3,100, "TOTAL_MEM", "SC", "circuit_level"):0.01005,
        (4,100, "X_MEM", "SC", "circuit_level"):0.01182, (4,100, "Z_MEM", "SC", "circuit_level"):0.00354, (4,100, "TOTAL_MEM", "SC", "circuit_level"):0.01183,
        (5,100, "X_MEM", "SC", "circuit_level"):0.01307, (5,100, "Z_MEM", "SC", "circuit_level"):0.00736, (5,100, "TOTAL_MEM", "SC", "circuit_level"):0.01311,
        (6,100, "X_MEM", "SC", "circuit_level"):0.01422, (6,100, "Z_MEM", "SC", "circuit_level"):0.00466, (6,100, "TOTAL_MEM", "SC", "circuit_level"):0.01424,
        ######### eta = 500 ###############
        (2,500, "X_MEM", "SC", "circuit_level"):0.00741, (2,500, "Z_MEM", "SC", "circuit_level"):0.00736, (2,500, "TOTAL_MEM", "SC", "circuit_level"):0.00738, 
        (3,500, "X_MEM", "SC", "circuit_level"):0.01002, (3,500, "Z_MEM", "SC", "circuit_level"):0.00466, (3,500, "TOTAL_MEM", "SC", "circuit_level"):0.01010,
        (4,500, "X_MEM", "SC", "circuit_level"):0.01186, (4,500, "Z_MEM", "SC", "circuit_level"):0.00354, (4,500, "TOTAL_MEM", "SC", "circuit_level"):0.01185,
        (5,500, "X_MEM", "SC", "circuit_level"):0.01318, (5,500, "Z_MEM", "SC", "circuit_level"):0.00736, (5,500, "TOTAL_MEM", "SC", "circuit_level"):0.01320,
        (6,500, "X_MEM", "SC", "circuit_level"):0.01441, (6,500, "Z_MEM", "SC", "circuit_level"):0.00466, (6,500, "TOTAL_MEM", "SC", "circuit_level"):0.01438,

        ######### eta = 1000 ###############
        (2,1000, "X_MEM", "SC", "circuit_level"):0.00741, (2,1000, "Z_MEM", "SC", "circuit_level"):0.00736, (2,1000, "TOTAL_MEM", "SC", "circuit_level"):0.00738, 
        (3,1000, "X_MEM", "SC", "circuit_level"):0.01001, (3,1000, "Z_MEM", "SC", "circuit_level"):0.00466, (3,1000, "TOTAL_MEM", "SC", "circuit_level"):0.01010,
        (4,1000, "X_MEM", "SC", "circuit_level"):0.01191, (4,1000, "Z_MEM", "SC", "circuit_level"):0.00354, (4,1000, "TOTAL_MEM", "SC", "circuit_level"):0.01192,
        (5,1000, "X_MEM", "SC", "circuit_level"):0.01323, (5,1000, "Z_MEM", "SC", "circuit_level"):0.00736, (5,1000, "TOTAL_MEM", "SC", "circuit_level"):0.01323,
        (6,1000, "X_MEM", "SC", "circuit_level"):0.01436, (6,1000, "Z_MEM", "SC", "circuit_level"):0.00466, (6,1000, "TOTAL_MEM", "SC", "circuit_level"):0.01439,

        #
        # ZXXZonSqu
        #
        ######### eta = 0.5 ################
        (2,0.5, "X_MEM", "ZXXZonSqu", "circuit_level"):0.00816, (2,0.5, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00817, (2,0.5, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.00821,
        (3,0.5, "X_MEM", "ZXXZonSqu", "circuit_level"):0.00959, (3,0.5, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00607, (3,0.5, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.00641,
        (4,0.5, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01045, (4,0.5, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00499, (4,0.5, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.00508,
        (5,0.5, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01099, (5,0.5, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00429, (5,0.5, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.00434,
        (6,0.5, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01149, (6,0.5, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00379, (6,0.5, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.00382,

        ######### eta = 10 ################
        (2,10, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01401, (2,10, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.01431, (2,10, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.01415,
        (3,10, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01633, (3,10, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.01112, (3,10, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.01321,
        (4,10, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01740, (4,10, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00354, (4,10, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.01196,
        (5,10, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01768, (5,10, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00736, (5,10, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.01029, # multiple, took lowest
        (6,10, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01844, (6,10, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00741, (6,10, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.00956, 
        ######### eta = 50 ###############
        (2,50, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01791, (2,50, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.01917, (2,50, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.01873,
        (3,50, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02079, (3,50, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (3,50, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.01990, # multiple crossings Z
        (4,50, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02189, (4,50, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00354, (4,50, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02069,
        (5,50, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02161, (5,50, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00736, (5,50, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02063,
        (6,50, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02273, (6,50, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (6,50, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02077,

        ######### eta = 100 ###############
        (2,100, "X_MEM", "ZXXZonSqu", "circuit_level"):0.01925, (2,100, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.02113, (2,100, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02015,
        (3,100, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02214, (3,100, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (3,100, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02208,
        (4,100, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02317, (4,100, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00354, (4,100, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02276,
        (5,100, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02251, (5,100, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00736, (5,100, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02260,
        (6,100, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02414, (6,100, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (6,100, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02384,
        ######### eta = 500 ###############
        (2,500, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02049, (2,500, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.02482, (2,500, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02341,
        (3,500, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02198, (3,500, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (3,500, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02421,
        (4,500, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02529, (4,500, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00354, (4,500, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02547,
        (5,500, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02414, (5,500, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00736, (5,500, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02429,
        (6,500, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02596, (6,500, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (6,500, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02591,

        ######### eta = 1000 ###############
        (2,1000, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02021, (2,1000, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.02637, (2,1000, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02474,
        (3,1000, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02476, (3,1000, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (3,1000, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02484,
        (4,1000, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02579, (4,1000, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00354, (4,1000, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02535,
        (5,1000, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02487, (5,1000, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00736, (5,1000, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02454,
        (6,1000, "X_MEM", "ZXXZonSqu", "circuit_level"):0.02645, (6,1000, "Z_MEM", "ZXXZonSqu", "circuit_level"):0.00466, (6,1000, "TOTAL_MEM", "ZXXZonSqu", "circuit_level"):0.02647,

    }

    p_th_init_bias_preserving_CL_pycorr = {
        ######### eta = 0.5 ################
        (2,0.5, "X_MEM_PY", "SC", "circuit_level"):0.00907, (2,0.5, "Z_MEM_PY", "SC", "circuit_level"):0.00979, (2,0.5, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00934, 
        (3,0.5, "X_MEM_PY", "SC", "circuit_level"):0.00966, (3,0.5, "Z_MEM_PY", "SC", "circuit_level"):0.00810, (3,0.5, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00865, 
        (4,0.5, "X_MEM_PY", "SC", "circuit_level"):0.01035, (4,0.5, "Z_MEM_PY", "SC", "circuit_level"):0.00688, (4,0.5, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00731, 
        (5,0.5, "X_MEM_PY", "SC", "circuit_level"):0.01087, (5,0.5, "Z_MEM_PY", "SC", "circuit_level"):0.00597, (5,0.5, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00621, 
        (6,0.5, "X_MEM_PY", "SC", "circuit_level"):0.01140, (6,0.5, "Z_MEM_PY", "SC", "circuit_level"):0.00536, (6,0.5, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00545,

        ######### eta = 10 ################
        (2,10, "X_MEM_PY", "SC", "circuit_level"):0.00795, (2,10, "Z_MEM_PY", "SC", "circuit_level"):0.03030, (2,10, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00789,
        (3,10, "X_MEM_PY", "SC", "circuit_level"):0.01024, (3,10, "Z_MEM_PY", "SC", "circuit_level"):0.02236, (3,10, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01018,
        (4,10, "X_MEM_PY", "SC", "circuit_level"):0.01167, (4,10, "Z_MEM_PY", "SC", "circuit_level"):0.01868, (4,10, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01174,
        (5,10, "X_MEM_PY", "SC", "circuit_level"):0.01273, (5,10, "Z_MEM_PY", "SC", "circuit_level"):0.01600, (5,10, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01269,
        (6,10, "X_MEM_PY", "SC", "circuit_level"):0.01342, (6,10, "Z_MEM_PY", "SC", "circuit_level"):0.01403, (6,10, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01325,

        ######### eta = 50 ###############
        (2,50, "X_MEM_PY", "SC", "circuit_level"):0.00778, (2,50, "Z_MEM_PY", "SC", "circuit_level"):0.00736, (2,50, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00777,
        (3,50, "X_MEM_PY", "SC", "circuit_level"):0.01020, (3,50, "Z_MEM_PY", "SC", "circuit_level"):0.00466, (3,50, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01029,
        (4,50, "X_MEM_PY", "SC", "circuit_level"):0.01189, (4,50, "Z_MEM_PY", "SC", "circuit_level"):0.00354, (4,50, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01208,
        (5,50, "X_MEM_PY", "SC", "circuit_level"):0.01313, (5,50, "Z_MEM_PY", "SC", "circuit_level"):0.02651, (5,50, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01311,
        (6,50, "X_MEM_PY", "SC", "circuit_level"):0.01425, (6,50, "Z_MEM_PY", "SC", "circuit_level"):0.02960, (6,50, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01414,

        ######### eta = 100 ###############
        (2,100, "X_MEM_PY", "SC", "circuit_level"):0.00773, (2,100, "Z_MEM_PY", "SC", "circuit_level"):0.00736, (2,100, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00775,
        (3,100, "X_MEM_PY", "SC", "circuit_level"):0.01023, (3,100, "Z_MEM_PY", "SC", "circuit_level"):0.00466, (3,100, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01023,
        (4,100, "X_MEM_PY", "SC", "circuit_level"):0.01204, (4,100, "Z_MEM_PY", "SC", "circuit_level"):0.00354, (4,100, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01198,
        (5,100, "X_MEM_PY", "SC", "circuit_level"):0.01327, (5,100, "Z_MEM_PY", "SC", "circuit_level"):0.00736, (5,100, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01320,
        (6,100, "X_MEM_PY", "SC", "circuit_level"):0.01436, (6,100, "Z_MEM_PY", "SC", "circuit_level"):0.00466, (6,100, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01433,
        ######### eta = 500 ###############
        (2,500, "X_MEM_PY", "SC", "circuit_level"):0.00775, (2,500, "Z_MEM_PY", "SC", "circuit_level"):0.00736, (2,500, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00767, 
        (3,500, "X_MEM_PY", "SC", "circuit_level"):0.01037, (3,500, "Z_MEM_PY", "SC", "circuit_level"):0.00466, (3,500, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01018,
        (4,500, "X_MEM_PY", "SC", "circuit_level"):0.01208, (4,500, "Z_MEM_PY", "SC", "circuit_level"):0.00354, (4,500, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01205,
        (5,500, "X_MEM_PY", "SC", "circuit_level"):0.01331, (5,500, "Z_MEM_PY", "SC", "circuit_level"):0.00736, (5,500, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01338,
        (6,500, "X_MEM_PY", "SC", "circuit_level"):0.01461, (6,500, "Z_MEM_PY", "SC", "circuit_level"):0.00466, (6,500, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01438,

        ######### eta = 1000 ###############
        (2,1000, "X_MEM_PY", "SC", "circuit_level"):0.00777, (2,1000, "Z_MEM_PY", "SC", "circuit_level"):0.00736, (2,1000, "TOTAL_MEM_PY", "SC", "circuit_level"):0.00771, 
        (3,1000, "X_MEM_PY", "SC", "circuit_level"):0.01026, (3,1000, "Z_MEM_PY", "SC", "circuit_level"):0.00466, (3,1000, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01036,
        (4,1000, "X_MEM_PY", "SC", "circuit_level"):0.01204, (4,1000, "Z_MEM_PY", "SC", "circuit_level"):0.00354, (4,1000, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01198,
        (5,1000, "X_MEM_PY", "SC", "circuit_level"):0.01333, (5,1000, "Z_MEM_PY", "SC", "circuit_level"):0.00736, (5,1000, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01333,
        (6,1000, "X_MEM_PY", "SC", "circuit_level"):0.01451, (6,1000, "Z_MEM_PY", "SC", "circuit_level"):0.00466, (6,1000, "TOTAL_MEM_PY", "SC", "circuit_level"):0.01451,

        #
        # ZXXZonSqu
        #
        ######### eta = 0.5 ################
        (2,0.5, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00958, (2,0.5, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00954, (2,0.5, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00954,
        (3,0.5, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01007, (3,0.5, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00783, (3,0.5, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00823,
        (4,0.5, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01067, (4,0.5, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00667, (4,0.5, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00692,
        (5,0.5, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01113, (5,0.5, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00573, (5,0.5, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00592,
        (6,0.5, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01164, (6,0.5, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00513, (6,0.5, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00525,

        ######### eta = 10 ################
        (2,10, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01491, (2,10, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01522, (2,10, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01514,
        (3,10, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01665, (3,10, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01269, (3,10, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01433,
        (4,10, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01758, (4,10, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01091, (4,10, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01310,
        (5,10, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01782, (5,10, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00979, (5,10, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01202, 
        (6,10, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01849, (6,10, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00902, (6,10, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01090, 
        ######### eta = 50 ###############
        (2,50, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01943, (2,50, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01969, (2,50, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01964,
        (3,50, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02059, (3,50, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01786, (3,50, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02000, 
        (4,50, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02188, (4,50, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01617, (4,50, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02077,
        (5,50, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02216, (5,50, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01444, (5,50, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02090,
        (6,50, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02281, (6,50, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01389, (6,50, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02142,

        ######### eta = 100 ###############
        (2,100, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02109, (2,100, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02153, (2,100, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02147,
        (3,100, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02239, (3,100, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02098, (3,100, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02211,
        (4,100, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02336, (4,100, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01938, (4,100, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02324,
        (5,100, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02355, (5,100, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01629, (5,100, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02290,
        (6,100, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02429, (6,100, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.01695, (6,100, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02392,
        ######### eta = 500 ###############
        (2,500, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02351, (2,500, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02567, (2,500, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02514,
        (3,500, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02462, (3,500, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00466, (3,500, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02449,
        (4,500, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02567, (4,500, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00354, (4,500, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02527,
        (5,500, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02574, (5,500, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00736, (5,500, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02561,
        (6,500, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02635, (6,500, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00466, (6,500, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02649,

        ######### eta = 1000 ###############
        (2,1000, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02548, (2,1000, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02678, (2,1000, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02622,
        (3,1000, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02443, (3,1000, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00466, (3,1000, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02455,
        (4,1000, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02588, (4,1000, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00354, (4,1000, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02581,
        (5,1000, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02628, (5,1000, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00736, (5,1000, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02663,
        (6,1000, "X_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02697, (6,1000, "Z_MEM_PY", "ZXXZonSqu", "circuit_level"):0.00466, (6,1000, "TOTAL_MEM_PY", "ZXXZonSqu", "circuit_level"):0.02719,
