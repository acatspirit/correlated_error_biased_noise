...
#SBATCH --array=0-9999                # How many jobs do you have (the int variable $SLURM_ARRAY_TASK_ID)
#SBATCH -c 1
...
#SBATCH --job-name=circuit_thresholds_no_corr_high_eta.out                # How is your output is called, you n$
