#!/bin/bash
#SBATCH -e slurm_compass_code_corr_err_l5_500000_large_d_parallel_2.err               # Error file location
...
#SBATCH --job-name=CorrErrL5Test_larged               # How is your output is called, you n$
