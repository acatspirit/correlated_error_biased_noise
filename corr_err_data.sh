...
#SBATCH --array=1-10                # How many jobs do you have (the int variable $SLURM_ARRAY_TASK_ID
#SBATCH -c 1
...
#SBATCH --job-name=corr_err_l5_eta0.01_1000_data.out               # How is your output is called, you n$
#SBATCH --job-name=x_corr_err_l5_eta0.01_1000_data.out               # How is your output is called, you n$
