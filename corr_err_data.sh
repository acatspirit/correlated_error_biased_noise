#!/bin/bash
#SBATCH -e slurm_compass_code_corr_err_l6_100000_large_d_parallel_2.err               # Error file location
...
#SBATCH --job-name=CorrErrL6Test_larged               # How is your output is called, you n$
