...
#SBATCH --job-name=corr_err_l3_eta5_10000_data.out               # How is your output is called, you n$
#SBATCH --job-name=x_corr_err_l3_eta5_10000_data.out               # How is your output is called, you n$
